...
const ProductDetails = () => {
    ...
    const getSimilarProduct = async (pid, cid) => {
        try {
            const { data } = await axios.get(
              `https://watchcart-backend.onrender.com/api/v1/product/related-product/${pid}/${cid}`
            );
        ...
        <div>
          ...
          >
            <div className="col-md-6 product-details-img">
              <img
                src={`https://watchcart-backend.onrender.com/api/v1/product/get-photo/${product._id}`}
                alt={product.name}
                height={400}
                width={400}
              />
